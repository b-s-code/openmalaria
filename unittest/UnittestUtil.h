...
public:
    static void initTime(int daysPerStep){
        ...
        dummyXML::modelParams.setLatentp("15d");
        ...
        util::ModelNameProvider modelNameProvider(dummyXML::scenario.getModel()); // TODO : does this crash since no model name?  Assume not.
